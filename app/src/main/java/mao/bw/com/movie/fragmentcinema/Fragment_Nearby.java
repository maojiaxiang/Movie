 ...
 * @Description：描述信息
 */
public class Fragment_Nearby extends Fragment implements DataCall<List<TuiJianBean>> {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.nearby_item, null, false);
        recyclerView = view.findViewById(R.id.recycle_nearby);
        ...
        recomPresenter.requestData(page);
