...
public class BeingAdapter extends RecyclerView.Adapter<BeingAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.being_item, null, false);
    ...
    public void allAdd(List<BeingBean> result) {
        mList.addAll(result);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            img = itemView.findViewById(R.id.b_img);
            name = itemView.findViewById(R.id.b_name);
            sm = itemView.findViewById(R.id.b_sm);
        }
    }
}
