...
public class RemenAdapter extends RecyclerView.Adapter<RemenAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.re_item, null, false);
    ...
    public void allAdd(List<MovieBean> result) {
        mList.addAll(result);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            sm = itemView.findViewById(R.id.r_sm);
        }
    }
}
